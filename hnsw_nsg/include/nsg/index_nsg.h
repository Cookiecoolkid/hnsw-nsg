...
class IndexNSG : public Index {
 public:
  ...
  void MySearch(const float *query,const float *x,size_t k,const Parameters &parameters, 
                    unsigned *indices) const;

  void SearchFromEnterpoint(const float *query, const float *x, size_t K, const Parameters &parameters, 
